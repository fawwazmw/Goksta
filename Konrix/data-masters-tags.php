...
// Find out the number of total tags in the database
  ...
  <div class="flex wrapper">
    ...
    <div class="page-content">
      ...
      <main class="flex-grow p-6">
        ...
        <?php
        $pageTitles = ["Konrix", "Data Masters", "Tags"];
            ...
            <div class="card-header">
              <div class="flex justify-between items-center">
                ...
                <div class="flex items-center gap-2">
                  <button class="btn border border-gray-700 text-gray-900 dark:text-gray-200 hover:bg-gray-700 hover:text-white transition duration-300 ease-in-out transform hover:scale-105" onclick="window.location.href='data-masters-tags-add.php'">
                  ...
                  <div class="border rounded-lg divide-y divide-gray-200 dark:border-gray-700 dark:divide-gray-700">
                    <div class="py-3 px-4">
                      <div class="relative max-w-xs">
                        ...
                        <form method="GET" action="data-masters-tags.php">
                    ...
                    <?php if (!empty($_GET['notif'])) : ?>
                      <?php if ($_GET['notif'] == "tambahberhasil") : ?>
                        <div class="bg-green-500 text-sm text-white rounded-md p-4 mx-2 mb-4" role="alert">
                          <span class="font-bold">Success</span> Your Tag has been added!
                        </div>
                      <?php elseif ($_GET['notif'] == "editberhasil") : ?>
                        <div class="bg-green-500 text-sm text-white rounded-md p-4 mx-2 mb-4" role="alert">
                          <span class="font-bold">Success</span> Your Tag has been edited!
                        </div>
                      <?php elseif ($_GET['notif'] == "deleteberhasil") : ?>
                        <div class="bg-green-500 text-sm text-white rounded-md p-4 mx-2 mb-4" role="alert">
                          <span class="font-bold">Success</span> Your Tag has been deleted!
                        </div>
                      <?php endif; ?>
                    <?php endif; ?>
                    <?php
                          ...
                          ?>
                            <tr>
                              ...
                              <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a class="text-blue-700 hover:text-blue-300 transition duration-300 ease-in-out transform hover:scale-105" href="data-masters-tags-edit.php?tag_id=<?php echo $id_tag; ?>">Edit</a>
                                <span class="mx-2">|</span>
                                <a class="text-danger hover:text-red-300 transition duration-300 ease-in-out transform hover:scale-105" href="auth-tags-delete.php?id_tag=<?php echo $id_tag; ?>" onclick="return confirm('Are you sure you want to delete this tag?');">Delete</a>
                              </td>
                            </tr>
                          <?php
                            $no++;
                    ...
                    <div class="py-1 px-4">
                      <nav class="flex items-center space-x-2">
                        <?php if ($page > 1) : ?>
                          <a class="text-gray-400 hover:text-primary p-4 inline-flex items-center gap-2 font-medium rounded-md" href="data-masters-tags.php?page=<?php echo $page - 1; ?>&search=<?php echo $search_query; ?>">
                        ...
                        <?php for ($i = 1; $i <= $total_pages; $i++) : ?>
                          ...
                          else echo 'text-gray-400 hover:text-primary'; ?> p-4 inline-flex items-center text-sm font-medium rounded-full" href="data-masters-tags.php?page=<?php echo $i; ?>&search=<?php echo $search_query; ?>" aria-current="page"><?php echo $i; ?></a>
                        <?php endfor; ?>
