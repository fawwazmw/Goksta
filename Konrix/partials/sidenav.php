        ...
        <ul class="menu" data-fc-type="accordion">
            ...
            <li class="menu-item">
                ...
                <ul class="sub-menu hidden">
                    <li class="menu-item">
                        <a href="posts-articles.php" class="menu-link">
                            <span class="menu-text">Articles</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="posts-comments.php" class="menu-link">
            ...
            <li class="menu-title">Data Masters</li>

            <li class="menu-item">
                <a href="javascript:void(0)" data-fc-type="collapse" class="menu-link">
                    <span class="menu-icon"><i class="mgc_building_2_line"></i></span>
                    <span class="menu-text"> Data Masters </span>
                    <span class="menu-arrow"></span>
                </a>

                <ul class="sub-menu hidden">
                    <li class="menu-item">
                        <a href="data-masters-categories.php" class="menu-link">
                            <span class="menu-text">Categories</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="data-masters-tags.php" class="menu-link">
            ...
            <li class="menu-title">User Managements</li>

            <li class="menu-item">
                <a href="javascript:void(0)" data-fc-type="collapse" class="menu-link">
                    <span class="menu-icon"><i class="mgc_building_2_line"></i></span>
                    <span class="menu-text"> User Managements </span>
                    <span class="menu-arrow"></span>
                </a>

                <ul class="sub-menu hidden">
                    <li class="menu-item">
                        <a href="user-managements-users.php" class="menu-link">
