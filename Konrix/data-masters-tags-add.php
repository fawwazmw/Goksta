  ...
  <div class="flex wrapper">
    ...
    <div class="page-content">
      ...
      <main class="flex-grow p-6">
        ...
        <?php
        $pageTitles = ["Konrix", "Data Masters", "Tags", "Add Tag"];
        include 'partials/page-title.php';
        ?>

        <form method="POST" action="auth-tags-add.php">
          <div class="flex flex-col gap-6">
            <div class="lg:col-span-3 space-y-6">
              <div class="card p-6">
                <div class="flex justify-between items-center mb-4">
                  <p class="card-title">Data Tag</p>
                ...
                <div class="flex flex-col gap-3">
                  <div class="">
                    <label for="title" class="mb-2 block">Title Tag</label>
                    <input type="text" id="title" name="title" class="form-input" placeholder="Enter Title" aria-describedby="input-helper-text" required>
                  </div>

                  <div class="">
                    <label for="content" class="mb-2 block">Content Tag <span class="text-red-500">*</span></label>
