  ...
  <section class="relative py-12 lg:pt-32">
    <div class="container px-4">
      <div class="grid grid-cols-1 lg:grid-cols-2 items-start">
        <div class="hidden lg:grid grid-cols-2 gap-4 items-stretch max-w-[580px]">
          <img class="rounded-3xl w-full hover-up" src="assets/imgs/pages/img-32.png" alt="">
          <img class="rounded-3xl w-full hover-up" src="assets/imgs/pages/img-33.png" alt="">
          <img class="rounded-3xl w-full hover-up" src="assets/imgs/pages/img-34.png" alt="">
          <img class="rounded-3xl w-full hover-up" src="assets/imgs/pages/img-35.png" alt="">
          <img class="rounded-3xl w-full hover-up col-span-2" src="assets/imgs/pages/img-36.png" alt="">
        </div>
        ...
        <div class="mr-12 lg:pl-12">
          ...
          <h3 class="heading-3 mb-2">Sign in <span class="font-light">to Your account</span></h3>
          <p class="text-neutral-700 dark:text-neutral-dark-700 mb-16 font-medium text-2xl">Log in to the system to receive paid quality <br>articles and many other great functions</p>
          <form action="">
            ...
            <div class="form-group flex justify-between mb-4 mt-6">
              <div class="flex items-center mb-8">
                ...
                <label for="save-info" class="text-sm text-neutral-950 dark:text-neutral-dark-950">Remember me</label>
              </div>
              <a href="#" class="text-neutral-950 dark:text-neutral-dark-950 underline text-sm">Forgot Password?</a>
            </div>
            ...
            <p class="text-center text-lg font-medium text-neutral-700 dark:text-neutral-dark-700 pt-8 pb-12">Do not have an account? <a href="page-register.php" class="text-neutral-950 dark:text-neutral-dark-950 underline">Create Now</a></p>
          </form>
        </div>
