...
<body class="bg-neutral-0 dark:bg-neutral-dark-0">
    ...
    <div class="container px-4">
      ...
      <div class="flex flex-col gap-8 items-center justify-center text-center">
        ...
        <div class="hidden md:flex gap-2.5  justify-start items-center h-12 px-7 py-3.5 bg-neutral-0 dark:bg-neutral-dark-0 rounded-3xl border border-neutral-300 dark:border-neutral-dark-300">
          ...
          <a href="category.php" class="text-neutral-700 dark:text-neutral-dark-700 text-base font-medium leading-normal">Contact Us</a>
        </div>
        <h1 class="heading-1 mb-0">
          Let’s Stay <span class="font-light">Connected</span>
        </h1>
        <p class="text-2xl font-medium text-center text-neutral-700 dark:text-neutral-dark-700 lg:max-w-[715px]">Call us, use our live chat widget or send us an email and we will get back to you as soon as possible.</p>
      </div>
    </div>
  </section>
  <section class="py-12">
    <div class="container px-4">
      <div class="max-w-[850px] mx-auto bg-neutral-0 dark:bg-neutral-dark-0 rounded-3xl p-8 md:p-12 lg:p-20 border border-neutral-200 dark:border-neutral-dark-200">
        <h4 class="text-neutral-950 dark:text-neutral-dark-950 text-3xl font-bold mb-8"><span class="font-light">Get In</span> Touch</h4>
        <form action="">
          ...
          <textarea placeholder="Message" class="textarea-default"></textarea>
  ...
  <section class="pb-24">
    <div class="container px-4">
      <div class="flex flex-col gap-8 md:flex-row justify-between items-center mx-auto lg:max-w-[950px]">
        <div class="flex flex-col item-center justify-center text-center">
          <div class="size-20 rounded-full bg-primary-light-950 dark:bg-primary-dark-950 flex items-center justify-center mx-auto">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="25" viewBox="0 0 30 25" class="fill-neutral-950 dark:fill-neutral-dark-950">
          ...
          <div class="mt-4">
            <h6 class="text-2xl font-bold text-neutral-950 dark:text-neutral-dark-950 mb-2">Send Email</h6>
            <p class="text-base font-medium text-neutral-700 dark:text-neutral-dark-700 mb-0">contact@ideko.com</p>
            <p class="text-base font-medium text-neutral-700 dark:text-neutral-dark-700 mb-0">support@ideko.com</p>
          </div>
        </div>
        <div class="flex flex-col item-center justify-center text-center">
          <div class="size-20 rounded-full bg-primary-light-950 dark:bg-primary-dark-950 flex items-center justify-center mx-auto">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" class="fill-neutral-950 dark:fill-neutral-dark-950">
          ...
          <div class="mt-4">
            <h6 class="text-2xl font-bold text-neutral-950 dark:text-neutral-dark-950 mb-2">Call Us</h6>
            <p class="text-base font-medium text-neutral-700 dark:text-neutral-dark-700 mb-0">(319) 555-0115</p>
            <p class="text-base font-medium text-neutral-700 dark:text-neutral-dark-700 mb-0">(239) 555-0108</p>
          </div>
        </div>
        <div class="flex flex-col item-center justify-center text-center">
          <div class="size-20 rounded-full bg-primary-light-950 dark:bg-primary-dark-950 flex items-center justify-center mx-auto">
          ...
          <div class="mt-4">
            <h6 class="text-2xl font-bold text-neutral-950 dark:text-neutral-dark-950 mb-2">Office</h6>
            <p class="text-base font-medium text-neutral-700 dark:text-neutral-dark-700 mb-0">4517 Washington Ave. </p>
            <p class="text-base font-medium text-neutral-700 dark:text-neutral-dark-700 mb-0">Manchester, Kentucky 39495</p>
          </div>
        </div>
      </div>
    </div>
  </section>
  <section class="relative py-10 lg:pb-24">
    <div class="container px-4">
      <div class="mx-auto grid lg:grid-cols-2 gap-8 lg:gap-16 items-center justify-center max-w-[1070px] bg-primary-light-300 dark:bg-primary-dark-300 rounded-3xl px-8 py-12 md:px-16 md:py-24 overflow-hidden relative">
        ...
        <div class="flex flex-col gap-8">
          ...
          <div class="flex flex-col md:flex-row gap-4">
            ...
            <a href="page-contact.php" class="btn border border-neutral-950 dark:bg-neutral-dark-0 rounded-full px-8 py-4 text-xl text-neutral-950 dark:text-neutral-dark-950 items-center">Contact Us</a>
          </div>
        </div>
